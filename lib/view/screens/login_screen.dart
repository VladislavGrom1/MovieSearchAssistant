        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              Center(child: Text("Movie Search Assistant", style: CustomTextStyles.m3HeadlineLarge(color: AppColors.primaryScheme))),
              ...
              TextFormField(
                ...
                decoration: InputDecoration(
                  label: Text("API Key", style: CustomTextStyles.m3BodyLarge(color: AppColors.primaryScheme)),
              ...
              ElevatedButton(
                ...
                child: Text("Проверить API Key", style: CustomTextStyles.m3BodyLarge(color: AppColors.primaryTextWhite)),
              ),
              SizedBox(height: 20.h),
              Center(child: Text(
              ...
              ElevatedButton(
                ...
                child: Text("Пропустить", style: CustomTextStyles.m3BodyLarge(color: AppColors.primaryTextWhite)),
              ),
            ],
          ),
        ),
